...
# Family Promise Endorses the Family Stability and Opportunity Vouchers Act 2021

<span class="et_pb_image_wrap"><img src="https://familypromise.org/wp-content/uploads/2021/03/us-capitol-building-washington-dc-po-power.jpg" title="us-capitol-building-washington-dc-po-power" class="wp-image-2155" sizes="(min-width: 0px) and (max-width: 480px) 480px, (min-width: 481px) 880px, 100vw" srcset="https://familypromise.org/wp-content/uploads/2021/03/us-capitol-building-washington-dc-po-power.jpg 880w, https://familypromise.org/wp-content/uploads/2021/03/us-capitol-building-washington-dc-po-power-480x320.jpg 480w" width="880" height="586" /></span>

<span class="published">June 21, 2021</span>

Family Promise is pleased and excited to endorse the Family Stability and Opportunity Vouchers Act, which would create 500,000 housing vouchers specifically prioritized for pregnant women and low-income families with children under the age of 6. We know that for every four eligible households, only 1 household receives much-needed housing assistance. We also know that families with young children are uniquely disadvantaged with regard to housing affordability, evidenced in the fact that 1 in 16 children experience homelessness by the time they reach kindergarten. We are hopeful that, if passed, this legislation would provide a unique resource to prevent trauma, homelessness, and housing instability for vulnerable families.

View the press release by [Opportunity Starts at Home](https://www.opportunityhome.org/campaigns-statement-on-the-introduction-of-the-family-stability-and-opportunity-vouchers-act-2021/) below:

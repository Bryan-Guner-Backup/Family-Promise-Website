!(function (t) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      ...
      function y(e) {
        var n = s,
          r = c;
        return (s = c = void 0), (g = e), (f = t.apply(r, n));
      }
      function b(t) {
      ...
      function x(t) {
        return (d = void 0), m && s ? y(t) : ((s = c = void 0), f);
      }
      function P() {
        var t = o(),
          n = _(t);
  ...
  function (t, e, n) {
    ...
    (j[O] =
      ...
      (t.exports = function t(e, n, B, L, T, A) {
        var C,
          M = 1 & n,
          I = 2 & n,
          F = 4 & n;
        if ((B && (C = T ? B(e, L, T, A) : B(e)), void 0 !== C)) return C;
        if (!w(e)) return e;
        var W = y(e);
        if (W) {
          if (((C = h(e)), !M)) return c(e, C);
        } else {
          var D = g(e),
          ...
          x(e)
            ...
            : _(e) &&
              e.forEach(function (r, o) {
                C.set(o, t(r, n, B, o, e, A));
              });
        var $ = W ? void 0 : (F ? (I ? p : d) : I ? S : P)(e);
        return (
          o($ || e, function (r, o) {
            $ && (r = e[(o = r)]), i(C, o, t(r, n, B, o, e, A));
          }),
          C
        );
      });
  ...
  function (t, e, n) {
    ...
    e.getOffsets = function (t) {
      var e =
        ...
        r = _ && t.hasClass("et_pb_sticky") && "fixed" !== t.css("position"),
        i = t.data("et-offsets"),
      ...
      if (c) {
        var d = t.parent().offset(),
          p = { top: s.top - d.top, left: s.left - d.left },
          g = { top: t[0].offsetTop, left: t[0].offsetLeft };
        (l += g.top - p.top), (s.top = l), (f += g.left - p.left), (s.left = f);
      }
      return (
        (s.right = f + e),
        (s.bottom = l + n),
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, a, u, s) {
      ...
      var g = -1,
        h = !0,
        v = 2 & n ? new r() : void 0;
      for (s.set(t, e), s.set(e, t); ++g < l; ) {
        var m = t[g],
          y = e[g];
        if (a) var b = c ? a(y, m, g, e, t, s) : a(m, y, g, t, e, s);
        if (void 0 !== b) {
          if (b) continue;
          h = !1;
          break;
        ...
        if (v) {
          if (
            !o(e, function (t, e) {
              if (!i(v, e) && (m === t || u(m, t, n, a, s))) return v.push(e);
            })
          ) {
            h = !1;
            break;
          }
        } else if (m !== y && !u(m, y, n, a, s)) {
          h = !1;
          break;
        }
      }
  ...
  function (t, e, n) {
    ...
    t.exports = function t(e, n, d, p, g, h, v, m, y, b) {
      var _ = 128 & n,
        ...
        O = x ? void 0 : a(e);
      return function k() {
        for (var E = arguments.length, j = Array(E), B = E; B--; )
          j[B] = arguments[B];
        if (P)
          var L = s(k),
            T = i(j, L);
        if (
          ...
          var A = l(j, L);
          return u(e, n, t, k.placeholder, d, j, A, m, y, b - E);
        }
        var C = w ? d : this,
          M = x ? C[e] : e;
        return (
          (E = j.length),
          m ? (j = c(j, m)) : S && E > 1 && j.reverse(),
          _ && y < E && (j.length = y),
          this && this !== f && this instanceof k && (M = O || a(M)),
          M.apply(C, j)
        );
      };
    };
  ...
  function (t, e) {
    ...
    t.exports = function (t, e, r, o) {
      for (
        ...
        d[i] = t[i];
      for (var g = i; ++c < l; ) d[g + c] = e[c];
      for (; ++u < s; ) (p || i < a) && (d[g + r[u]] = t[i++]);
      return d;
    };
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    var v = new RegExp(
      ...
      m = function (t) {
        ...
        return "" === n || (0, i.default)(n)
          ? e
          : (n.substr(0 - d, d) === f &&
              ((a -= d), (n = n.substr(0, a).trim())),
            (0, o.default)(l, n.substr(-4, 4))
              ? n.substr(-4, 4)
              : (0, o.default)(c, n.substr(-3, 3))
              ? n.substr(-3, 3)
              : (0, o.default)(s, n.substr(-2, 2))
              ? n.substr(-2, 2)
              : (0, o.default)(u, n.substr(-1, 1))
              ? "%"
              : e);
      };
    e.getUnit = m;
    e.getNumber = function (t, e) {
      return (0, c.maybeFloat)(t, e);
    };
    var y = function (t, e) {
      return (0, o.default)(
    ...
    e.isAcceptableCSSStringValue = y;
    ...
    var _ = function (t) {
      return (0, u.default)(t)
        ...
        .reduce(function (t, e) {
          ...
          return e.match(v)
            ? [r].concat(f(o), [e])
            : [r ? "".concat(r, ", ").concat(e) : e].concat(f(o));
        }, []);
    };
    e.sanitizeCSSSelector = _;
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, r, c, f, d) {
      switch (n) {
        ...
        case "[object Set]":
          var g = 1 & r;
          if ((p || (p = s), t.size != e.size && !g)) return !1;
          var h = d.get(t);
          if (h) return h == e;
          (r |= 2), d.set(t, e);
          var v = a(p(t), p(e), r, c, f, d);
          return d.delete(t), v;
        case "[object Symbol]":
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, i, a, u) {
      ...
      for (var v = s; ++f < l; ) {
        var m = t[(d = c[f])],
          y = e[d];
        if (i) var b = s ? i(y, m, d, e, t, u) : i(m, y, d, t, e, u);
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      for (
        var o = -1, i = t.criteria, a = e.criteria, u = i.length, s = n.length;
        ++o < u;
    ...
    t.exports = function t(e, n, c, l) {
      ...
      var p = !("cap" in l) || l.cap,
        ...
        D = {
          castArray: function (t) {
            return function () {
              var e = arguments[0];
              return B(e) ? t(u(e)) : t.apply(void 0, arguments);
            };
          },
          iteratee: function (t) {
            return function () {
          ...
          mixin: function (t) {
            return function (e) {
              var n = this;
              if (!T(n)) return t(n, Object(e));
              var r = [];
              return (
                j(C(e), function (t) {
                  T(e[t]) && r.push([t, n.prototype[t]]);
                }),
                t(n, Object(e)),
                j(r, function (t) {
                  var e = t[1];
                  T(e) ? (n.prototype[t[0]] = e) : delete n.prototype[t[0]];
                }),
                n
              );
            };
      ...
      function $(t, e, n) {
        return m && n > 1 && (w || !r.skipRearg[t])
          ? M(e, r.methodRearg[t] || r.aryRearg[n])
          : e;
      }
      function H(t, e) {
        for (
          ...
          c
            ...
            : v &&
              (r.mutate.array[i]
                ...
                : r.mutate.set[i] && (a = s(e, H))),
          j(W, function (t) {
            return (
              j(r.aryMethod[t], function (e) {
                if (i == e) {
                  var n = r.methodSpread[i],
                    u = n && n.afterRearg;
                  return (
                    (o = u ? R(i, $(i, a, t), t) : $(i, R(i, a, t), t)),
                    (o = (function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      ...
      return function o() {
        for (var f = arguments.length, d = Array(f), p = f, g = u(o); p--; )
          d[p] = arguments[p];
        var h = f < 3 && d[0] !== g && d[f - 1] !== g ? [] : s(d, g);
        if ((f -= h.length) < n)
          return a(t, e, i, o.placeholder, void 0, d, h, void 0, void 0, n - f);
        var v = this && this !== c && this instanceof o ? l : t;
        return r(v, this, d);
      };
    };
  },
      ...
      return function e() {
        for (
          var o = -1,
            ...
            f = a.length,
            d = Array(f + c),
            p = this && this !== i && this instanceof e ? s : t;
          ++l < f;

        )
          d[l] = a[l];
        for (; c--; ) d[l++] = arguments[++o];
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e) {
      var n = t[1],
        ...
        d =
          (c == u && 8 == n) ||
          (c == u && 256 == n && t[7].length <= e[8]) ||
          (384 == c && e[7].length <= e[8] && 8 == n);
      if (!f && !d) return t;
      1 & c && ((t[2] = e[2]), (l |= 1 & n ? 0 : 4));
      var p = e[3];
      if (p) {
        var g = t[3];
  ...
  function (t, e, n) {
    var r = n(17)("toString", n(4), n(56));
    (r.placeholder = n(13)), (t.exports = r);
  },
  function (t, e, n) {
    var r = n(17)("split", n(283));
    (r.placeholder = n(13)), (t.exports = r);
  },
  function (t, e, n) {
    var r = n(45),
  ...
  function (t, e, n) {
    var r = n(17)("head", n(41), n(56));
    (r.placeholder = n(13)), (t.exports = r);
  },
  function (t, e, n) {
    var r = n(17)("size", n(119), n(56));
    (r.placeholder = n(13)), (t.exports = r);
  },
  function (t, e, n) {
    var r = n(293),
  ...
  function (t, e, n) {
    var r = n(45),
      ...
      c = n(4);
    t.exports = function (t, e, n) {
      if ((t = c(t)) && (n || void 0 === e)) return o(t);
      if (!t || !(e = r(e))) return t;
      var l = s(t),
        f = s(e),
        d = u(l, f),
  ...
  function (t, e, n) {
    ...
    var E = function (t) {
      var e =
        arguments.length > 1 && void 0 !== arguments[1]
          ? arguments[1]
          : "desktop";
      return !(0, c.default)(t) || (0, f.default)(t)
        ? t
    ...
    e.getLastEditedFieldName = j;
    var B = function (t) {
      var e =
          !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
        n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
        r = [t, E(t, "tablet"), E(t, "phone"), j(t)];
      return e || r.shift(), n || r.pop(), r;
    };
    e.getFieldNames = B;
    var L = function (t) {
      if ((0, f.default)(t) || !(0, c.default)(t)) return t;
      var e = t.split("_");
    ...
    e.getFieldBaseName = L;
    var T = function (t, e) {
      var n =
        arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "";
      if ((0, f.default)(t) || (0, f.default)(e) || !(0, c.default)(e))
        return "";
      var r = e.split("_"),
    ...
    var A = function (t, e) {
      ...
      if ("tablet" === o) return u;
      var s = (0, h.default)(t, "".concat(i, "_tablet"), u);
      return "phone" === o ? s : n;
    };
    ...
    var C = function (t, e) {
      ...
      return (
        (r = "" === r ? "desktop" : r),
        (0, f.default)(t) || (0, f.default)(e) || !(0, c.default)(e)
          ? n
          : ("desktop" !== r && (e = "".concat(L(e), "_").concat(r)),
            (0, h.default)(t, e, n))
      );
    };
    e.getValue = C;
    var M = function (t, e) {
      ...
      if (
        ...
        return "";
      "desktop" !== o && (e = "".concat(L(e), "_").concat(o));
    ...
    var I = function (t, e) {
      ...
      var i = (0, h.default)(t, e),
        a = A(t, e, n);
      return r ? ((0, s.default)(i) ? a : i) : i === a ? "" : i;
    };
    e.getAnyDefinedValue = I;
    var F = function (t, e) {
      var n =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
        r = (0, h.default)(t, e, n);
    ...
    var D = {
      ...
      getFieldName: E,
      getFieldNames: B,
      getLastEditedFieldName: j,
      getFieldBaseName: L,
      getValue: C,
      getAnyValue: M,
      getAnyDefinedValue: I,
  ...
  function (t, e, n) {
    ...
    var U = "settings_change",
      ...
      Y = {
        wpAdminBar: {
          ...
          condition: function () {
            var t =
              "fixed" ===
              j.top_window.jQuery(K.wpAdminBar.selector).css("position");
            return (
              !(K.builderAppFramePaddingTop.getHeight() > 0) &&
              !T.isTB &&
              !T.isLBB &&
              t
            );
        ...
        diviFixedPrimaryNav: {
          ...
          window: "app",
          condition: function () {
            var t = T.isDiviTheme && q,
              e = (0, k.default)(K.diviFixedPrimaryNav.selector).length > 0,
              n =
                "fixed" ===
                (0, k.default)(K.diviFixedPrimaryNav.selector).css("position");
            return t && e && n;
          },
          getHeight: function () {
            var t = (0, k.default)(Y.diviFixedPrimaryNav.selector);
            if (!T.isDiviTheme && 1 > t.length) return 0;
            var e = t.clone();
        ...
        diviFixedSecondaryNav: {
          ...
          condition: function () {
            var t = T.isDiviTheme && q,
              e = (0, k.default)(K.diviFixedSecondaryNav.selector).length > 0,
              n =
                "fixed" ===
                (0, k.default)(K.diviFixedSecondaryNav.selector).css(
                  "position"
                );
            return t && e && n;
          },
        ...
        extraFixedPrimaryNav: {
          ...
          window: "app",
          condition: function () {
            if (!(0, v.default)(L.default) || !T.isExtraTheme) return !1;
            var t = T.isExtraTheme && q,
              e = (0, k.default)(K.extraFixedPrimaryNav.selector).length > 0,
              n = 1024 <= L.default.width + L.default.verticalScrollBar;
            return t && e && n;
          },
          getHeight: function () {
            var t = (0, k.default)(Y.extraFixedPrimaryNav.selector);
            if (!T.isExtraTheme && 1 > t.length) return 0;
            var e = t.clone();
            e.addClass("et-fixed-header et-script-temporary-measurement"),
              t.parent().append(e);
            var n = e.outerHeight();
        ...
        builderAppFramePaddingTop: {
          ...
          selector: T.isBFB ? "#et-bfb-app-frame" : "#et-fb-app-frame",
          exist: !1,
          height: 0,
          window: "top",
          getHeight: function () {
            var t = K.builderAppFramePaddingTop.selector,
              e = T.isBFB ? "marginTop" : "paddingTop",
              n = j.top_window.jQuery(t).css(e);
            return parseFloat(n);
          },
        },
        tbHeader: {
      ...
      G = (function (t) {
        ...
        function C() {
          ...
          return (
            ...
            z(H((t = o.call(this))), "onDocumentHeightChange", function () {
            ...
            z(H(t), "onBuilderDidMount", function () {
            ...
            z(H(t), "onBuilderSettingsChange", function (e) {
              var n =
                  arguments.length > 1 &&
                  void 0 !== arguments[1] &&
                  arguments[1],
              ...
              ((0, g.default)(r, t.modules) && !n) ||
                ((Z = (0, A.filterInvalidModules)((0, a.default)(r), Z)),
                (0, i.default)(Z, Q),
                t.generateOffsetModules(),
                t.emit(U));
            }),
            z(H(t), "getModulesId", function (t) {
              return (0, _.default)(t, function (t) {
                return t.id;
              });
            }),
            z(H(t), "getModulesByPosition", function (e) {
              var n =
                arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
              return (0, s.default)(Z, function (r, o) {
            ...
            z(H(t), "setProp", function (e, n, r) {
              (0, f.default)(Z, e) &&
                !(0, m.default)(e) &&
                t.getProp(e, n) !== r &&
                (0, x.default)(Z, "".concat(e, ".").concat(n), r);
            }),
            z(H(t), "getProp", function (e, n, r) {
              var o =
                  !(arguments.length > 3 && void 0 !== arguments[3]) ||
                  arguments[3],
                i = (0, l.default)(Z, "".concat(e, ".").concat(n), r),
                a =
                  o &&
                  (0, v.default)(i) &&
              ...
              return a
                ? (0, l.default)(
                    i,
                    (0, l.default)(L.default, "breakpoint", "desktop"),
                    r
                  )
                : i;
            }),
            z(H(t), "setElementsProps", function () {
              (0, c.default)(K, function (e, n) {
                  ...
                  if (
                    ...
                    return (
                      t.setElementProp(
                        n,
                        "exist",
                        (0, l.default)(Y, "".concat(n, ".exist"), !1)
                      ),
                      void t.setElementProp(
                        n,
                        "height",
                        (0, l.default)(Y, "".concat(n, ".height"), 0)
                      )
                    );
                  var r = (
            ...
            z(H(t), "setElementProp", function (e, n, r) {
              t.getElementProp(e, n) !== r &&
                (0, x.default)(K, "".concat(e, ".").concat(n), r);
            }),
            z(H(t), "getElementProp", function (t, e, n) {
              return (0, l.default)(K, "".concat(t, ".").concat(e), n);
            }),
            z(H(t), "setElementHeight", function (e) {
              ...
              (0, c.default)(t.modules, function (e, n) {
                ...
                if (e.bottomOffsetModulesAlign) {
                  ...
                  t.setProp(
                    n,
                    "bottomOffsetModules",
                    (0, u.default)([i].concat(M(a)))
                  );
                }
              });
            }),
            z(H(t), "isSticky", function (e) {
              return (0, l.default)(t.modules, [e, "isSticky"], !1);
            }),
            z(H(t), "addSettingsChangeListener", function (e) {
              return (
                (0, T.maybeIncreaseEmitterMaxListeners)(H(t), U),
                t.on(U, e),
                H(t)
              );
            }),
            z(H(t), "removeSettingsChangeListener", function (e) {
              return (
                t.removeListener(U, e),
                (0, T.maybeDecreaseEmitterMaxListeners)(H(t), U),
                H(t)
              );
            }),
            (0, i.default)(Z, Q),
            ...
            B.default.addHeightChangeListener(t.onDocumentHeightChange),
            T.isBuilder &&
      ...
      J = new G();
    (0, T.registerFrontendComponent)("stores", "sticky", J);
    var X = J;
    e.default = X;
  },
  ,
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, s) {
      if (!a(t)) return t;
      for (
        var c = -1, l = (e = o(e, t)).length, f = l - 1, d = t;
        null != d && ++c < l;
  ...
  function (t, e, n) {
    ...
    var O,
      ...
      A = "scroll_top_change",
      C = "breakpoint_change",
      M = "scroll_location_change",
      I = "vertical_scroll_bar_change",
      F = {
        breakpoint: "desktop",
      ...
      W = {
        scrollLocation:
          ((O = et_builder_utils_params.scrollLocations),
          (function (t) {
        ...
        function s() {
          ...
          !(function (t, e) {
            ...
            P(_((t = o.call(this))), "setHeight", function () {
              ...
              return n === F.height[e] || ((F.height[e] = n), t.emit(L)), _(t);
            }),
            P(_(t), "setWidth", function () {
              ...
              return (F.width[e] = n), t.emit(T), _(t);
            }),
            P(_(t), "setScrollLocation", function (e) {
              return (
                !!(0, u.default)(W.scrollLocation, e) &&
                (e === F.scrollLocation || ((F.scrollLocation = e), t.emit(M)),
                _(t))
              );
            }),
            ...
            P(_(t), "setVerticalScrollBarWidth", function () {
              ...
              return (
                n === F.verticalScrollBar[e] ||
                  ((F.verticalScrollBar[e] = n), t.emit(I)),
                _(t)
              );
            }),
            ...
            P(_(t), "addScrollLocationChangeListener", function (e) {
              return (
                (0, g.maybeIncreaseEmitterMaxListeners)(_(t), M),
                t.on(M, e),
                _(t)
              );
            }),
            P(_(t), "removeScrollLocationChangeListener", function (e) {
              return (
                ...
                (0, g.maybeDecreaseEmitterMaxListeners)(_(t), M),
                _(t)
              );
            }),
            ...
            P(_(t), "setBreakpoint", function (e) {
              ...
              if (
                ...
                return (F.breakpoint = n), t.emit(C), _(t);
            }),
    ...
    (0, i.default)(B, function (t) {
      ...
      r.addEventListener("resize", function () {
        ...
        $.setWidth(t, e).setHeight(t, n),
          $.setVerticalScrollBarWidth(t, r.outerWidth - e),
          (($.width > 782 && n <= 782) || ($.width <= 782 && n > 782)) &&
            setTimeout(function () {
              f.default.setElementHeight("wpAdminBar"), $.emit(A);
            }, 300);
      }),
        ...
        e &&
          (o.on("et_fb_preview_mode_changed", function (t, e, n) {
            var r = $.getBuilderScrollLocation(n);
            $.setBuilderZoomedStatus(n), $.setScrollLocation(r);
          }),
          g.isBFB &&
        ...
        n &&
          ((g.isFE || g.isVB) &&
            $.addBreakpointChangeListener(function () {
              f.default.setElementsProps();
            }),
          g.isLBP &&
            (r.addEventListener("ETBlockGbBlockOrderChange", function () {
              setTimeout(function () {
                $.setLayoutBlockPreviewIframeOffset(), $.emit(A);
              }, 300);
            }),
      ...
      (0, g.registerFrontendComponent)("stores", "window", $);
    var H = $;
    e.default = H;
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    e.trimTransitionValue = function (t, e) {
      ...
      return (0, s.default)(o) ? "none" : o.join(", ");
    };
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, c) {
      ...
      n && (e = a(e, u(n))),
        c
          ? ((f = i), (d = !1))
          : e.length >= 200 && ((f = s), (d = !1), (e = new r(e)));
      t: for (; ++l < p; ) {
        var v = t[l],
          m = null == n ? v : n(v);
  ...
  function (t, e, n) {
    ...
    var M = function t(e) {
      ...
      !(function (t, e) {
        ...
        C(this, "lockStyleClassname", "et-script-sticky-temporary-height-lock"),
        C(this, "startStickyFinalStyleTimeout", void 0),
        C(this, "endStickyUnlockParentTimeout", void 0),
        C(this, "removeListeners", function () {
        ...
        C(this, "getSettings", function () {
          return n.settings;
        }),
        C(this, "getThemeFixedPrimaryNavName", function () {
          return k.isDiviTheme
            ? "diviFixedPrimaryNav"
            : !!k.isExtraTheme && "extraFixedPrimaryNav";
        }),
        C(this, "setSettings", function (t) {
          var e =
            arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
          (n.settings = A({}, t)),
            n.setProp("id", t.id),
        ...
        C(this, "getSetting", function (t, e) {
        ...
        C(this, "getProp", function (t, e) {
          return (0, a.default)(n.props, t, e);
        }),
        C(this, "isProp", function (t, e) {
          return e === n.getProp(t);
        }),
        C(this, "setProp", function (t, e) {
          (0, y.default)(n.props, t, e),
            (0, s.default)(n.storeSync, t) &&
              O.default.setProp(n.getProp("id"), t, e);
        }),
        C(this, "setInitialProps", function () {
          var t =
              arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
          ...
          var o =
            ...
            i =
              n.isProp("position", "top") || n.isProp("position", "top_bottom");
          if (o) {
          ...
          if (i) {
            ...
            n.setProp(
              "bottomLimitSettings",
              (0, E.getLimit)(n.getProp("$selector"), s)
            );
          }
          if (!(r.closest(".et_is_animating").length > 0)) {
            ...
            n.setProp("heightSticky", (0, a.default)(p, "height", l)),
              n.setProp("widthSticky", (0, a.default)(p, "width", c)),
        ...
        C(this, "updateInlineStyles", function () {
          var t = {},
          ...
          if ((n.setProp("offsets", u), !(0, l.default)(t))) {
            var c = n.getFinalInlineStyleLeft();
            c && (t.left = (0, g.default)(c) ? "".concat(c, "px") : c),
              n.getProp("$selector").css(t);
          }
        }),
        C(this, "setOnPageHelperStyles", function () {
        ...
        C(this, "hasSticky", function (t) {
          return t === n.getSetting(t);
        }),
        C(this, "parseOffsetToPx", function (t) {
          if (!(0, w.hasValue)(t)) return 0;
          (0, x.getUnit)(t);
          return parseInt(t);
        }),
        C(this, "getModuleWidth", function () {
        ...
        C(this, "getOffset", function (t) {
          ...
          if (r("knownElement")) {
            ...
            u &&
              h &&
              O.default.getElementProp("diviFixedSecondaryNav", "exist", !1) &&
        ...
        C(this, "getRelativePositionOffset", function (t) {
        ...
        C(this, "getPlaceholder", function () {
          return (0,
          _.default)('[data-sticky-placeholder-id="'.concat(n.getProp("id"), '"]'));
        }),
        C(this, "getPropertyValueInPx", function (t) {
          var e =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : "",
        ...
        C(this, "getFinalInlineStyleLeft", function () {
          ...
          if ("max-width" === c() && !(0, w.hasValue)(o) && r < u) return e;
          var l = "max-width" === c() ? u : o,
            f = n.getSetting(
              "stickyStyles.".concat(c()),
              n.getSetting("styles.".concat(c()), l)
            ),
            p = "center" === t ? 2 : 1;
        ...
        C(this, "willStickyScroll", function (t) {
          ...
          var e = "top" === t,
            ...
            c = e ? u >= o : u < o + r,
            l = !c && s;
          return s !== c && n.setProp("topBottomPosition", t), c || l;
        }),
        C(this, "onWindowScroll", function () {
          if (!n.isProp("position", "none")) {
            ...
            var u = n.getProp("pauseScrollTop"),
              s = n.getProp("height"),
              c = (0, a.default)(n.getProp("offsets"), "top", 0),
            ...
            if (
              ...
              if (n.isStickyScroll("top")) {
                var w =
                  (0, a.default)(l, "offsets.bottom", 0) -
                  n.getOffset("bottom", "surrounding");
                n.getProp("$selector").css({ top: "".concat(w - s, "px") });
              }
        ...
        C(this, "onBreakpointChange", function () {
          var t = A({}, n.props),
        ...
        C(this, "onDiviFixedHeaderTransitionEnd", function (t) {
          n.getProp("isSticky") &&
            n.getProp("isPaused") &&
            (n.endSticky(),
        ...
        C(this, "toggleAffectingParentsClassname", function (t) {
        ...
        C(this, "startSticky", function () {
          ...
          n.isStickyScroll("top") &&
            (t
              ? (s.top = "".concat(0 + n.getOffset("top"), "px"))
              : ((s.top = "".concat(
                  P.default.scrollTop + n.getOffset("top"),
                  "px"
                )),
            ...
            n.isStickyScroll("bottom") &&
              (t
                ? (s.bottom = "".concat(0 + n.getOffset("bottom"), "px"))
                : (s["will-change"] = "top"),
              (s.top = "auto"),
              (s.marginBottom = "0px"));
          ...
          c &&
            ...
            (s.transition = (0, E.trimTransitionValue)(l, [
              "top",
              "right",
              "bottom",
              "left",
            ]));
          var f = "position: fixed !important; padding: ".concat(
            ...
            v = n.getProp("marginLeftSticky");
          (0 === h && 0 === d) ||
            (f += " margin-right: ".concat(h, "px !important;")),
            (0 === v && 0 === p) ||
              (f += " margin-left: ".concat(v, "px !important;")),
            n.getProp("$selector").css({ cssText: f }).css(s),
            setTimeout(function () {
              n.unlockParentHeight();
            }, 1);
          var m = n.getPropertyValueInPx(
              "stickyStyles.width",
              n.getPropertyValueInPx("styles.width", "")
            ),
            y = n.getPropertyValueInPx("stickyStyles.max-width");
          ((0, w.hasValue)(m) || (0, w.hasValue)(y) || c) &&
            (n.startStickyFinalStyleTimeout = setTimeout(function () {
              ...
              if (
                ...
                (0, w.hasValue)(m) &&
                  (t.width = (0, g.default)(m) ? "".concat(m, "px") : m),
                (0, w.hasValue)(y) &&
                  (t["max-width"] = (0, g.default)(y) ? "".concat(y, "px") : y),
                s.transition &&
                  ("top" === P.default.scrollLocation
                    ? (t.transition = (0, E.trimTransitionValue)(l, ["top"]))
                    : (t.transition = "")),
                c)
              ) {
                var r = n.getRelativePositionOffset("vertical");
                (0, g.default)(s.top) && (t.top = "".concat(s.top + r, "px")),
                  (0, g.default)(s.bottom) &&
                    (t.bottom = "".concat(s.bottom + r, "px"));
              }
              n.getProp("$selector").css(t);
            }, 50)),
            (0, j.toggleAllBackgroundLayoutClassnameOnSticky)(
              n.getProp("$selector"),
              !0
            );
        }),
        C(this, "pauseSticky", function () {
          ...
          if (n.isStickyScroll("bottom") && t) {
            ...
            n.setProp(
              "pauseScrollTop",
              (0, a.default)(e, "offsets.bottom", 0) - (r + n.getOffset("top"))
            );
            var i =
              P.default.scrollTop -
              n.getProp("pauseScrollTop") +
        ...
        C(this, "endSticky", function () {
          ...
          var f =
            1e3 * parseFloat(n.getProp("$selector").css("transition-duration"));
          (0, g.default)(f) || (f = 0),
            ...
            (n.endStickyUnlockParentTimeout = setTimeout(function () {
              n.unlockParentHeight(),
                ...
                n.resetInitialPropsOnStickyEnd &&
                  (n.setInitialProps(), (n.resetInitialPropsOnStickyEnd = !1));
            }, f));
        }),
        C(this, "lockParentHeight", function () {
        ...
        C(this, "unlockParentHeight", function () {
          n.getProp("$selector")
      ...
      var B = this.getProp("$selector")[0];
      "object" === L(B) &&
        this.domObserver.observe(B, {
          attributes: !0,
          childList: !0,
          subtree: !0,
        }),
    ...
    t.exports = function t(e, n, l, f, d) {
      e !== n &&
        i(
          n,
          function (i, s) {
            if ((d || (d = new r()), u(i))) a(e, n, s, l, t, f, d);
            else {
              var p = f ? f(c(e, s), i, s + "", e, n, d) : void 0;
              void 0 === p && (p = i), o(e, s, p);
            }
          },
          s
        );
  ...
  function (t, e, n) {
    ...
    (function (t) {
      ...
      var et,
        nt = {},
        rt = ["et_pb_row", "et_pb_row_inner"],
        ot = ["et_pb_column", "et_pb_column_inner"],
        it = function (t) {
          switch (t) {
            case "force_left":
              return "left";
          ...
          function t() {
            !(function (t, e) {
              ...
              tt(
                this,
                "postID",
                (0, a.default)(window.ETBuilderBackend, "currentPage.id")
              ),
              tt(
                this,
                "path",
                (0, a.default)(window.ETBuilderBackend, "cookie_path")
              );
          }
          var e, n, r;
          return (
      ...
      t(window).on("et_fb_init", function () {
        (st = window.ET_Builder.Frames.app), (ct = st.document);
      });
      var dt = {
            ...
            return (
              (0, g.default)(n, function (e) {
                (0, E.default)(e, function (e, n) {
                  (0, u.default)(t[n])
                    ? (t[n] = (0, B.default)(e) ? e.bind(t) : e)
                    : (t[n] = (0, B.default)(e)
                        ? (0, L.default)(t[n], e.bind(t))
                        : t[n]);
                });
              }),
              t
        ...
        sanitized_previously: H.sanitizedPreviously,
        log: function (t, e, n) {
        ...
        getOS: function () {
          if (!(0, u.default)(window.navigator)) {
        ...
        isModuleLocked: function (t, e) {
          var n = t.props || t,
            r = (0, a.default)(n, "address"),
            o =
              dt.isOn((0, a.default)(n, "attrs.locked")) ||
              (0, a.default)(n, "lockedParent");
          if (!o) {
            var i = dt.getModuleAddressSequence(r);
            (0, g.default)(i, function (t) {
              var n = (0, x.default)(e, { address: t });
              if (
                dt.isOn((0, a.default)(n, "attrs.locked")) ||
                (0, a.default)(n, "lockedParent")
              )
        ...
        isModuleDeleted: function (t, e) {
          var n =
            !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
          if ((0, a.default)(t, "attrs._deleted")) return !0;
          if (n) {
            var r = (0, a.default)(t, "address", "").split(".");
            if (r.length > 1) {
              var o = dt.getModuleAddressSequence(r),
                i = !1;
              if (
                ((0, g.default)(o, function (t) {
                  var n = (0, x.default)(e, { address: t });
                  (0, a.default)(n, "attrs._deleted") && (i = !0);
                }),
                i)
              )
                return !0;
        ...
        getComponentType: function (t) {
          var e = t.props || t,
            n = (0, a.default)(e, "type"),
            r = "module";
          switch (!0) {
            case "et_pb_section" === n:
              r = "section";
              break;
            case (0, h.default)(rt, n):
              r = "row";
              break;
        ...
        getModuleSectionType: function (t, e) {
          var n = t.props || t,
            r = (0, S.default)((0, a.default)(n, "address").split(".")),
            o = (0, x.default)(e, { address: r });
          return dt.isOn((0, a.default)(o, "attrs.fullwidth"))
            ? "fullwidth"
            : dt.isOn((0, a.default)(o, "attrs.specialty"))
            ? "specialty"
            : "regular";
        },
        getModuleAncestor: function (t, e, n) {
          var r,
            o = e.props || e,
            i = dt.getModuleSectionType(o, n),
            u = dt.getModuleAddressSequence((0, a.default)(o, "address", ""));
          return (
            (0, g.default)(u, function (e) {
              var o = (0, x.default)(n, { address: e }),
                u = (0, a.default)(o, "type", "");
              if ("specialty" === i)
                0 === u.replace("et_pb_", "").indexOf(t) && (r = o);
              else u.replace("et_pb_", "") === t && (r = o);
            }),
            r
          );
        },
        is: function (t, e) {
          ...
          switch (t) {
            ...
            case "row":
              ...
              break;
            case "row-inner":
              r = "et_pb_row_inner" === (0, a.default)(n, "type");
              break;
            case "column":
              r = "column" === Le(n);
              break;
            case "column-inner":
              r = "et_pb_column_inner" === (0, a.default)(n, "type");
              break;
            case "module":
              r = "module" === Le(n) && !(0, a.default)(n, "is_module_child");
              break;
            case "fullwidth":
              r = bt((0, a.default)(n, "attrs.fullwidth"));
              break;
            case "regular":
              r =
                "section" === Le(n) &&
                !bt((0, a.default)(n, "attrs.fullwidth")) &&
                !bt((0, a.default)(n, "attrs.specialty"));
              break;
            case "specialty":
              r = bt((0, a.default)(n, "attrs.specialty"));
              break;
            case "disabled":
              r = bt((0, a.default)(n, "attrs.disabled"));
              break;
            case "locked":
              r = bt((0, a.default)(n, "attrs.locked"));
              break;
            case "removed":
              r =
                "et-fb-removed-component" ===
                (0, a.default)(n, "component_path", "");
              break;
            default:
              r = (0, a.default)(n, t);
          }
        ...
        isBlockEditor: function () {
          return (0, j.default)(window, "wp.blocks");
        },
        ...
        getConditionalDefault: function (t, e, n, r) {
          if (!(0, f.default)(t) || !(0, l.default)((0, a.default)(t, "1")))
            return t;
          var o = G(t, 2),
            i = o[0],
            s = o[1];
          r && (i = z.default.getHoverField(i));
          var c = n ? n.resolve(i) : (0, a.default)(e, i);
          return (
            (0, u.default)(c) && (c = (0, w.default)(s)[0]),
            (0, a.default)(s, c)
          );
        },
        getValueOrConditionalDefault: function (t, e, n) {
          var r = (0, a.default)(e, t);
          return (0, u.default)(r) || "" === r
            ? dt.getConditionalDefault((0, a.default)(n, t), e)
            : r;
        },
        condition: function (t) {
          return (0, a.default)(ETBuilderBackend, ["conditionalTags", t]);
        },
        ...
        getResponsiveStatus: function (t) {
          var e = (0, c.default)(t) ? t.split("|") : ["off", "desktop"];
          return !(0, u.default)(e[0]) && this.isOn(e[0]);
        },
        getResponsiveLastMode: function (t) {
          var e = (0, c.default)(t) ? t.split("|") : ["off", "desktop"];
          return (0, a.default)(e, [1], "desktop");
        },
            ...
            t("body").append(d),
              d.on("load", function () {
                if (!p) {
                  ...
                  !(0, u.default)(i) && i < 10 && (g = JSON.stringify(g)),
                    t.contentWindow.postMessage(g, s),
                    (p = !0);
        ...
        processFontIcon: function (e, n) {
          ...
          return (
            null === e.trim().match(/^%%/) ||
              (0, u.default)(o[r]) ||
              (e = o[r]),
            e ? t.parseHTML((0, s.default)(e))[0].nodeValue : null
          );
        },
        generateResponsiveCss: function (t, e, n, r) {
          if ((0, d.default)(t)) return "";
          var o = [];
          return (
            (0, g.default)(t, function (t, i) {
              if ("" !== t && void 0 !== t) {
                var a = { selector: e, declaration: "", device: i },
                  u = void 0 !== r && "" !== r ? r : ";";
                Array.isArray(t) && !(0, d.default)(t)
                  ? (0, g.default)(t, function (t, e) {
                      "" !== t &&
                        (a.declaration += ""
                          .concat(e, ":")
                          .concat(t)
        ...
        getPrevBreakpoint: function (t) {
          return dt.getBreakpoints()[
            (0, A.default)(dt.getBreakpoints(), t) - 1
          ];
        },
        ...
        getGradient: function (t) {
          var e = dt.gradientDefault(),
            n =
              "linear" ===
              (t = (0, r.default)(e, (0, o.default)(t, this.hasValue))).type
                ? t.direction
                : "circle at ".concat(t.radialDirection),
            i = N.default.sanitizeInputUnit(t.startPosition, void 0, "%"),
            a = N.default.sanitizeInputUnit(t.endPosition, void 0, "%");
          return ""
            .concat(t.type, "-gradient(\n      ")
            .concat(n, ",\n      ")
            .concat(t.colorStart, " ")
            .concat(i, ",\n      ")
            .concat(t.colorEnd, " ")
        ...
        getRowLayouts: function (t, e) {
          ...
          if ("et_pb_row_inner" === t && !(0, u.default)(e)) {
            var r = ETBuilderBackend.columnLayouts.specialty[e];
            n = (0, b.default)((0, _.default)(r.columns), function (t) {
              var e = t + 1;
              return 1 === e
                ? "4_4"
                : (0, b.default)((0, _.default)(e), function () {
                    return "1_".concat(e);
                  }).join(",");
            });
          }
        ...
        maybeLoadFont: function (e, n) {
          var r = this.$topWindow("head").add(t("head")),
            ...
            f = (0, w.default)(ETBuilderBackend.websafeFonts),
            d =
            ...
            p =
              void 0 !== o[e] && void 0 !== o[e].character_set
                ...
                : "",
            v = (0, a.default)(s, "".concat(e, ".parent_font"), !1)
              ? s[e].parent_font
              : e,
            m = this.fontnameToClass(e);
          if ((0, u.default)(i[e])) {
            if (r.find("link#".concat(m)).length || !l || (0, h.default)(f, e))
              return;
            (e = v.replace(/ /g, "+")),
              r.append(
                '<link id="'
                  .concat(m, '" href="//fonts.googleapis.com/css?family=')
                  .concat(e)
                  .concat(d)
                  .concat(p, '" rel="stylesheet" type="text/css" />')
              );
          } else {
            if (r.find("style#".concat(m)).length) return;
            var y = (0, a.default)(i[e], "font_url", ""),
              b = (0, c.default)(y) ? "src: url('".concat(y, "');") : "";
            if ("" === b && !(0, c.default)(y)) {
              var _ = {
                eot: {
                  url: (0, a.default)(y, "eot", !1),
                  format: "embedded-opentype",
                },
                woff2: { url: (0, a.default)(y, "woff2", !1), format: "woff2" },
                woff: { url: (0, a.default)(y, "woff", !1), format: "woff" },
                ttf: { url: (0, a.default)(y, "ttf", !1), format: "truetype" },
                otf: { url: (0, a.default)(y, "otf", !1), format: "opentype" },
              };
              _.eot.url &&
                (b = "src: url('"
                  .concat(_.eot.url, "'); src: url('")
                  .concat(_.eot.url, "?#iefix') format('embedded-opentype')")),
                (0, g.default)(_, function (t, e) {
                  "eot" !== e &&
                    t.url &&
                    ((b += "" === b ? "src: " : ", "),
                    (b += "url('"
            ...
            r.append(
              '<style id="'
                .concat(m, '">@font-face{font-family:"')
                .concat(e, '"; ')
                .concat(b, ";}</style>")
            );
          }
        ...
        callWindow: function (t) {
          if ((0, j.default)(window, t)) {
            for (
              ...
              n[r - 1] = arguments[r];
            (0, a.default)(window, t).apply(void 0, n);
          }
        },
        ...
        topViewportWidth: function () {
          return this.isTB()
            ? this.$TBViewport().width()
            : this.topWindow().innerWidth;
        },
        topViewportHeight: function () {
          return this.isTB()
            ? this.$TBViewport().height()
            : this.$topWindow().height();
        },
        viewportScrollTop: function () {
          var t = this.appWindow().ET_Builder.API.State.View_Mode;
          return this.isTB()
            ? this.$TBScrollTarget().scrollTop()
            : this.isBFB() || t.isPhone() || t.isTablet() || t.isZoom()
            ? this.$topWindow().scrollTop()
            : this.$appWindow().scrollTop();
        },
        getTopWindowWidth: function () {
          return dt.isBFB()
            ? dt.$topWindow("#et_pb_layout").width()
            : dt.$topWindow().width();
        },
        getAppWindowWidth: function () {
          return dt.$appWindow().width();
        },
          ...
          var t =
            ...
            r =
              arguments.length > 3 && void 0 !== arguments[3]
                ...
                : 0;
          if (dt.isBFB())
            return dt.topDocument().getElementById("et_pb_layout").clientWidth;
          var o = e && t,
            i = (0, a.default)(
              dt.appWindow(),
            ...
            u = dt.maybeGetScrollbarWidth(i.current),
            s = dt.getTopWindowWidth();
          return (
            u && dt.isTB() && (s -= u),
            o && (0, h.default)(["left", "right"], n) && (s -= r),
            s
          );
        },
        appDocument: function () {
        ...
        isElementInViewport: function (e) {
          if ((e.length > 0 && (e = e[0]), !(0, d.default)(e))) {
            ...
            if (r) {
              ...
              var u = r.height(),
                s = 0;
              return (
                this.hasFixedHeader() && (s = t("header").height()),
                a <= u && a >= s
              );
            }
          }
        ...
        decodeHtmlEntities: function (t) {
          return (t = (0, c.default)(t) ? t : "").replace(
            /&#(\d+);/g,
            function (t, e) {
            ...
            e
              ...
              .each(function () {
                ...
                e.hasClass("et_pb_circle_counter") &&
                  (dt.appWindow().et_pb_reinit_circle_counters(e),
                  (0, u.default)(e.data("easyPieChart")) ||
                    e.data("easyPieChart").update(e.data("number-value"))),
                  e.hasClass("et_pb_number_counter") &&
                    (dt.appWindow().et_pb_reinit_number_counters(e),
                    (0, u.default)(e.data("easyPieChart")) ||
                      e.data("easyPieChart").update(e.data("number-value"))),
                  e.find(".et_pb_counter_amount").length > 0 &&
                    e.find(".et_pb_counter_amount").each(function () {
                      dt.appWindow().et_bar_counters_init(t(this));
                    }),
                  e.css({ opacity: "1" });
              }),
              ...
              dt.appWindow().et_reinit_waypoint_modules(),
              (0, u.default)(window.et_shortcodes_init) ||
                dt.appWindow().et_shortcodes_init(e),
              dt.$appWindow().trigger("resize");
          }, 0);
        },
          ...
          clearTimeout(window.ETBuilderFauxResize),
            (window.ETBuilderFauxResize = setTimeout(function () {
              ...
              t(window).trigger("resize"),
                dt.callWindow("et_fix_page_container_position"),
                n.condition("is_bfb") &&
                  setTimeout(function () {
        ...
        getHeadingLevel: function (t) {
          var e =
            ...
            n = t.parentAttrs,
            r = t.attrs;
          return this.hasValue(r.header_level)
            ? r.header_level
            : this.hasValue(n) && this.hasValue(n.header_level)
            ? n.header_level
            : e;
        },
        generateRowStructureClass: function (t) {
          if (
            (0, u.default)(t.content) ||
            "" === t.content ||
            (0, d.default)(t.content)
          )
            return "";
          var e = "";
          switch (
            ((0, g.default)(t.content, function (t) {
              var n = (0, a.default)(t, "attrs.type");
              n &&
                (0, c.default)(n) &&
        ...
        shouldComponentUpdate: function (t, e, n) {
          ...
          return (
            t.props.wireframeMode &&
              ((r = this._cleanPropsForWireframeComparison(e)),
              (o = this._cleanPropsForWireframeComparison(t.props))),
            !(0, k.default)(r, o) || !(0, k.default)(n, t.state)
          );
        },
        shouldComponentUpdateDelayed: function (t, e) {
          if (!1 !== e.isInViewport) return !1;
          var n = t.props,
            r = n.previewMode,
            o = n._v,
            i = e.previewMode,
        ...
        shouldComponentUpdateInViewport: function (t, e, n) {
          var r = e && (0, l.default)(e) ? Z({}, e) : {},
            o = t && t.props && (0, l.default)(t.props) ? Z({}, t.props) : {},
            i = t && t.state && (0, l.default)(t.state) ? Z({}, t.state) : {},
            a = n && (0, l.default)(n) ? Z({}, n) : {},
            u = o.isInViewport,
            s = o.computedState,
            c = r.isInViewport,
            f = r.computedState;
          if (!1 !== u || !1 !== c || u !== c) return !0;
          var d = i.isInViewportUpdater,
            p = a.isInViewportUpdater;
          if (s === f && d === p) {
            var g = dt.getPropsFlat(r),
              h = dt.getPropsFlat(o);
            return (0, V.default)(h, function (t) {
              var e = t._key,
                n = t.shortcode_index,
                r = (0, x.default)(g, function (t) {
                  return t._key === e;
                });
        ...
        whyComponentDidUpdate: function (t, e, n, r) {
          if (t) {
            var o = t.props,
              ...
              c = {},
              f = {};
            (0, g.default)(u, function (t, n) {
              if ((0, l.default)(t))
                (0, g.default)(t, function (t, o) {
                  var i = (0, a.default)(e, "".concat(n, ".").concat(o));
                  (0, k.default)(t, i) ||
                    (c["".concat(n, ":").concat(o)] = {
                      currentProps: t,
                      previousProps: i,
              ...
              (0, d.default)(c) || console.table(c),
              (0, g.default)(s, function (t, e) {
                if ((0, l.default)(t))
                  (0, g.default)(t, function (t, o) {
                    var i = (0, a.default)(n, "".concat(e, ".").concat(o));
                    (0, k.default)(t, i) ||
                      (f["".concat(e, ":").concat(o)] = {
                        currentState: t,
                        previousState: i,
              ...
              (0, d.default)(f) || console.table(f);
          }
        },
        findObjectByKeyDeep: function (t, e) {
          var n;
          return (
            (0, g.default)(t, function (t, r) {
              return r === e
                ? ((n = t), !0)
                : (0, l.default)(t)
                ? ((n = dt.findObjectByKeyDeep(t, e)), !(0, p.default)(n))
                : void 0;
            }),
            n
          );
        ...
        _cleanPropsForWireframeComparison: function (t) {
          ...
          var n = (0, M.default)(t, ["attrs", "children", "content"]);
          return (
            t.attrs &&
              (n.attrs = (0, i.default)(t.attrs, [
                "locked",
                "global_module",
                "admin_label",
                "collapsed",
            ...
            t.content && (0, f.default)(t.content) && !(0, d.default)(t.content)
              ? ((n.content = []),
                (0, g.default)(t.content, function (t) {
                  n.content.push(e._cleanPropsForWireframeComparison(t));
                }))
              : (0, f.default)(t.content) || (n.content = ""),
            n
          );
        },
        getAdminBarHeight: function () {
          if (this.isTB()) return 32;
          var t = this.$topWindow("#wpadminbar");
          return t.length > 0 ? parseInt(t.innerHeight()) : 0;
        },
        getScrollbarWidth: H.getScrollbarWidth,
        maybeGetScrollbarWidth: function (t) {
          if (dt.isBFB()) return 0;
          var e = dt.$topWindow("html"),
            n = dt.$appWindow("html"),
            r = dt.isTB() ? dt.getAdminBarHeight() : 0,
            o = dt.$topDocument("#et-fb-app-frame").outerHeight(!0),
            i = e.outerHeight();
          return (
            (0, h.default)(["desktop", "wireframe"], t) &&
              ((o = n.innerHeight() + r), (i = dt.$topWindow().innerHeight())),
            (0, h.default)(["zoom"], t) &&
              ((o = Math.ceil(n.innerHeight() / 2) + r),
              (i = dt.$topWindow().innerHeight())),
            o > i ? dt.getScrollbarWidth() : 0
          );
        },
        getScrollTargets: function () {
          ...
          return (
            dt.isTB()
              ? (e = this.$TBScrollTarget())
              : dt.isBlockEditor() ||
                (!dt.isBFB() && (t.isDesktop() || t.isWireframe())) ||
                (e = dt.$topWindow("html")),
            e
          );
        },
        getScrollEventTarget: function () {
          var t = dt.appWindow().ET_Builder.API.State.View_Mode,
            e = dt.appWindow();
          return (
            dt.isTB()
              ? (e = this.$TBScrollTarget().get(0))
              : (dt.isBFB() || (!t.isDesktop() && !t.isWireframe())) &&
                (e = dt.topWindow()),
            e
          );
        ...
        enableScrollLock: function () {
          var t = dt.$topWindow(".et-fb-page-settings-bar"),
            e = dt.$topWindow("#wpadminbar"),
            n = dt.$topWindow(
          ...
          this.getScrollTargets().css({
            overflowY: "hidden",
            paddingRight: "".concat(dt.getScrollbarWidth(), "px"),
          }),
            dt.isBFB() ||
              (o || u || t.css("width", "calc(100% - ".concat(et, "px)")),
              i &&
                t
                  .find(".et-fb-page-settings-bar__column--right")
                  .css("right", "".concat(et, "px"))),
            ...
            dt.isBFB() ||
              ...
              i &&
                t
                  .find(".et-fb-page-settings-bar__column--right")
                  .css("right", "0px")),
            dt.condition("is_bfb") && e.css("width", "100%"),
            n.css("width", ""),
            r.css("width", "");
        },
        cookies: ut,
        ...
        setElementFont: function (t, e, n) {
          ...
          if (!(0, d.default)(i)) {
            var c = i[0],
              ...
              h = "on" === i[5],
              v = "on" === i[6],
              m = (0, u.default)(i[7]) ? "" : i[7],
              y = (0, u.default)(i[8]) ? "" : i[8],
              b = "" !== s[1] ? s[1] : "",
              _ = "on" === s[2],
              w = "on" === s[3],
              x = "on" === s[4],
            ...
            (l = "on" === l ? "700" : l),
              ...
              "" !== c &&
                "Default" !== c &&
                (this.maybeLoadFont(c),
                (r += (function (t, e) {
                  var n,
                    r,
                    o,
                    i,
                    s = (0, j.default)(ETBuilderBackend.customFonts, t, !1)
                      ? ETBuilderBackend.customFonts
                      : ETBuilderBackend.et_builder_fonts_data,
                    c = e ? " !important" : "",
                    l = ETBuilderBackend.removedFonts;
                  return (
                    (i =
                      (0, u.default)(s[t]) ||
                      (0, u.default)(s[t].add_ms_version)
                        ? ""
                        : "'".concat(t, " MS', ")),
                    (0, a.default)(l, t, !1) &&
                      ((r = l[t].styles), (t = l[t].parent_font)),
              ...
              (r += o("font-weight", "" !== b, "" !== l, "normal", l, e)),
              (r += o("font-style", _, f, "normal", "italic", e)),
              (r += o("text-transform", w, p, "none", "uppercase", e)),
              (r += o("text-decoration", x, g, "none", "underline", e)),
              (r += o("font-variant", P, h, "none", "small-caps", e)),
              (r += o("text-decoration", S, v, "none", "line-through", e)),
              (r += o("text-decoration-style", !1, "" !== y, "solid", y, e)),
        ...
        setResetFontStyle: function (t, e) {
          var n =
            arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
          if (!(0, c.default)(t) || !(0, c.default)(e)) return "";
          var r = t.split("|"),
            o = e.split("|");
          if ((0, d.default)(r) || (0, d.default)(o)) return "";
          var i = !(0, u.default)(r[2]) && "on" === r[2],
            a = !(0, u.default)(r[3]) && "on" === r[3],
            s = !(0, u.default)(r[4]) && "on" === r[4],
            l = !(0, u.default)(r[5]) && "on" === r[5],
            f = !(0, u.default)(r[6]) && "on" === r[6],
            p = !(0, u.default)(o[2]) && "on" === o[2],
            g = !(0, u.default)(o[3]) && "on" === o[3],
            h = !(0, u.default)(o[4]) && "on" === o[4],
            v = !(0, u.default)(o[5]) && "on" === o[5],
            m = !(0, u.default)(o[6]) && "on" === o[6],
            y = "",
            b = n ? " !important" : "";
          if (
            (!i && p && (y += "font-style: normal".concat(b, ";")),
            !a && g && (y += "text-transform: none".concat(b, ";")),
            !l && v && (y += "font-variant: none".concat(b, ";")),
            !s && h)
          ) {
            var _ = f || m ? "line-through" : "none";
            y += "text-decoration: ".concat(_).concat(b, ";");
          }
          if (!f && m) {
            var w = s || h ? "underline" : "none";
            y += "text-decoration: ".concat(w).concat(b, ";");
          }
          return y;
        },
        decodeOptionListValue: function (t) {
          ...
          return t
            ? JSON.parse(
                (0, y.default)((0, y.default)(t, e[0], n[0]), e[1], n[1])
              )
            : t;
        },
        moduleHasBackground: function (t, e) {
          var n,
            r,
            o = this,
            i = (0, u.default)(e) ? ["color", "gradient", "image", "video"] : e,
            a = !1;
          return (
        ...
        getTextOrientation: (0, O.default)(it, function (t) {
          return dt.condition("is_rtl") && "left" === t ? "right" : t;
        }),
        isBuilderFocused: function () {
          return (
            this.$appDocument(ETBuilderBackend.css.containerPrefix).is(
              ":hover"
            ) ||
            this.$topDocument(ETBuilderBackend.css.containerPrefix).is(":hover")
          );
        },
        getFixedHeaderHeight: function () {
          var t = dt.$appWindow("body");
          return (
            t.hasClass("et_divi_theme") &&
              dt.$topWindow().width() >= 980 &&
              !t.hasClass("et_vertical_nav") &&
              (parseInt(dt.$appWindow("#top-header.et-fixed-header").height()),
              parseInt(dt.$appWindow("#main-header.et-fixed-header").height())),
            t.hasClass("et_extra") &&
              parseInt(dt.$appWindow(".et-fixed-header #main-header").height()),
            0
          );
        },
        parseInlineCssIntoObject: function (t) {
          return (0, I.default)(
            (0, b.default)(t.split("; "), function (t) {
              return t.split(": ");
            })
          );
        },
        ...
        getModuleAddressSequence: function (t) {
          ...
          var n = (0, w.default)(e),
            r = [];
          return (
            (0, g.default)(n, function (t) {
              var n = parseInt(t, 10) + 1,
                o = (0, P.default)(e, n).join(".");
              r.push(o);
            }),
            r
          );
        ...
        flattenFields: function (t) {
          return (0, W.default)(
            ...
            function (t, e, n) {
              if ("composite" === e.type) {
                var o = (0, a.default)(e, "composite_structure", {}),
                  i = (0, b.default)(o, "controls").reduce(function (t, n) {
                    var o = (0, D.default)(n, function (t, n) {
                      var o = (0, a.default)(t, "name", n),
                        i = (0, a.default)(
                          t,
                          "tab_slug",
                          (0, a.default)(e, "tab_slug", "")
                        ),
                        u = (0, a.default)(
                          t,
                          "toggle_slug",
                          (0, a.default)(e, "toggle_slug", "")
                        );
                      return (0,
                      r.default)({}, t, { name: o, tab_slug: dt.getProcessedTabSlug(i), toggle_slug: u });
                    });
                    return Z(Z({}, t), o);
                  }, {});
                return Z(Z({}, t), i);
        ...
        hasLocalStorage: function () {
          if (!(0, m.default)(ft)) return ft;
          try {
            ft = !!ET_Builder.Frames.top.localStorage;
          } catch (t) {}
          return ft;
        },
        showCoreModal: function (t) {
          if (ETBuilderBackend[t]) {
            ...
            u = this.sprintf(i, u);
            var s =
                (0, w.default)(r).length > 1 ? "et-core-modal-two-buttons" : "",
              c = this.sprintf(o, e, n, u);
            this.$topWindow(".et-core-modal-overlay").remove(),
              this.$topWindow(c)
                .appendTo(this.$topWindow("body"))
                .addClass(s)
                .addClass(a),
        ...
        scrollToAddress: function (t, e) {
          var n =
              arguments.length > 2 && void 0 !== arguments[2]
                ? arguments[2]
                : "desktop",
            r = dt.$appWindow('[data-address="'.concat(t, '"]'));
          if (r && r.length) {
            var o =
                dt.isTB() ||
                dt.isBFB() ||
                (0, h.default)(["zoom", "tablet", "phone"], n),
              i = o ? dt.$topWindow("html") : dt.$appWindow("html");
            dt.isTB() && (i = dt.$TBScrollTarget());
            var a = r.offset().top;
            "zoom" === n && (a = Math.ceil(0.5 * a));
            var u = dt.viewportScrollTop(),
              s = dt.isBFB()
                ? dt.$topWindow("#et-bfb-app-frame").offset().top -
                  dt.getAdminBarHeight()
                : 0,
              c =
                dt.isTB() || dt.isBFB()
                  ? 0
                  : dt.$appWindow("#et-boc").offset().top,
              l = a + s - c,
              f = Math.abs(l - u),
              d = 400,
              p = 800,
      ...
      (dt.maybeLoadFont = (0, F.default)(dt.maybeLoadFont.bind(dt))),
        ...
        (window.ET_FB.utils = {
          ...
          debug: function () {
            if (!(0, u.default)(nt.debug)) return nt.debug;
            try {
              return (
                (nt.debug = "true" === localStorage.getItem("et_fb_debug")),
                nt.debug
              );
            } catch (t) {
              return !1;
          ...
          debugLogAreas: function () {
            ...
            return !(0, u.default)(nt.enableAllLogAreas) && nt.enableAllLogAreas
              ? this.defaultAllLogAreas
              : (0, u.default)(nt.enabledLogAreas)
              ? null === t
                ? this.defaultAllLogAreas
                : t.split(" ")
              : nt.enabledLogAreas;
      ...
      var pt = dt.applyMixinsSafely,
        gt = dt.intentionallyCloneDeep,
        ht = dt.intentionallyClone,
        vt = dt.sanitized_previously,
        mt = dt.log,
        yt = dt.is,
        bt = dt.isOn,
        _t = dt.isOff,
        ...
        Pt = dt.isNo,
        St = dt.isDefault,
        Ot = dt.isMobileDevice,
        kt = dt.isIEOrEdge,
        Et = dt.isIE,
        jt = dt.isBlockEditor,
        Bt = dt.condition,
        Lt = dt.hasLocalStorage,
        Tt = dt.hasNumericValue,
        At = dt.hasValue,
        Ct = dt.getResponsiveStatus,
        Mt = dt.parseShortcode,
        It = dt.processFontIcon,
        Ft = dt.generateResponsiveCss,
        Wt = dt.generatePlaceholderCss,
        Dt = dt.replaceCodeContentEntities,
        Vt = dt.removeFancyQuotes,
        Rt = dt.processRangeValue,
        $t = dt.getCorners,
        Ht = dt.getCorner,
        Nt = dt.getSpacing,
        zt = dt.closestElement,
        Ut = dt.getBreakpoints,
        qt = dt.getViewModeByWidth,
        Qt = dt.getPreviewModes,
        Yt = dt.getGradient,
        Kt = dt.removeClassNameByPrefix,
        Zt = dt.getKeyboardList,
        Gt = dt.getRowLayouts,
        Jt = dt.maybeLoadFont,
        Xt = dt.fontnameToClass,
        te = dt.getCommentsMarkup,
        ee = dt.callWindow,
        ne = dt.decodeHtmlEntities,
        re = dt.hasBodyMargin,
        oe = dt.fixSliderHeight,
        ie = dt.fixBuilderContent,
        ae = dt.triggerResizeForUIUpdate,
        ue = dt.enableScrollLock,
        se = dt.disableScrollLock,
        ce = dt.linkRel,
        le = dt.setElementFont,
        fe = dt.decodeOptionListValue,
        de = dt.sprintf,
        pe = dt.isJson,
        ge = dt.isValidHtml,
        he = dt.getNextBreakpoint,
        ve = dt.getPrevBreakpoint,
        me = dt.appDocument,
        ye = dt.$appDocument,
        be = dt.appWindow,
        _e = dt.$appWindow,
        ...
        Pe = dt.topWindow,
        Se = dt.$topWindow,
        Oe = dt.getFixedHeaderHeight,
        ke = dt.parseInlineCssIntoObject,
        Ee = dt.getOS,
        je = dt.isModuleLocked,
        Be = dt.isModuleDeleted,
        Le = dt.getComponentType,
        Te = dt.getModuleSectionType,
        Ae = dt.getModuleAncestor,
        Ce = dt.getScrollbarWidth,
        Me = dt.getProcessedTabSlug,
        Ie = dt.getModuleAddressSequence,
        Fe = dt.getFontFieldIndexes,
        We = dt.isRealMobileDevice,
        De = dt.stripHTMLTags;
      (e.stripHTMLTags = De),
        (e.isRealMobileDevice = We),
        (e.getFontFieldIndexes = Fe),
        (e.getModuleAddressSequence = Ie),
        (e.getProcessedTabSlug = Me),
        (e.getScrollbarWidth = Ce),
        (e.getModuleAncestor = Ae),
        (e.getModuleSectionType = Te),
        (e.getComponentType = Le),
        (e.isModuleDeleted = Be),
        (e.isModuleLocked = je),
        (e.getOS = Ee),
        (e.parseInlineCssIntoObject = ke),
        (e.getFixedHeaderHeight = Oe),
        (e.$topWindow = Se),
        (e.topWindow = Pe),
        (e.$topDocument = xe),
        (e.topDocument = we),
        ...
        (e.$appDocument = ye),
        (e.appDocument = me),
        (e.getPrevBreakpoint = ve),
        (e.getNextBreakpoint = he),
        (e.isValidHtml = ge),
        (e.isJson = pe),
        (e.sprintf = de),
        (e.decodeOptionListValue = fe),
        (e.setElementFont = le),
        (e.linkRel = ce),
        (e.disableScrollLock = se),
        (e.enableScrollLock = ue),
        (e.triggerResizeForUIUpdate = ae),
        (e.fixBuilderContent = ie),
        (e.fixSliderHeight = oe),
        (e.hasBodyMargin = re),
        (e.decodeHtmlEntities = ne),
        (e.callWindow = ee),
        (e.getCommentsMarkup = te),
        (e.fontnameToClass = Xt),
        (e.maybeLoadFont = Jt),
        (e.getRowLayouts = Gt),
        (e.getKeyboardList = Zt),
        (e.removeClassNameByPrefix = Kt),
        (e.getGradient = Yt),
        (e.getPreviewModes = Qt),
        ...
        (e.getCorner = Ht),
        (e.getCorners = $t),
        (e.processRangeValue = Rt),
        (e.removeFancyQuotes = Vt),
        (e.replaceCodeContentEntities = Dt),
        (e.generatePlaceholderCss = Wt),
        (e.generateResponsiveCss = Ft),
        (e.processFontIcon = It),
        (e.parseShortcode = Mt),
        (e.getResponsiveStatus = Ct),
        (e.hasValue = At),
        (e.hasNumericValue = Tt),
        ...
        (e.is = yt),
        (e.log = mt),
        (e.sanitized_previously = vt),
        (e.intentionallyClone = ht),
        (e.intentionallyCloneDeep = gt),
        (e.applyMixinsSafely = pt);
      var Ve = dt;
      e.default = Ve;
    }.call(this, n(22)));
  },
          ...
          s = function (t, r, s, c, l, f) {
            ...
            for (m = 0, y = s.length; m < y; m++)
              switch (s.charAt(m)) {
                ...
                case "-":
                  ...
                  break;
                case "'":
                  m + 1 < y && ((b = s.charAt(m + 1)), m++);
              }
            if (((c = c ? +c : 0), !isFinite(c)))
            ...
            switch (((v = r ? e[+r] : e[n++]), f)) {
              case "%":
                return "%";
              case "s":
                return u("".concat(v), _, c, l, b);
              case "c":
                return u(String.fromCharCode(+v), _, c, l, b);
              case "b":
                return a(v, 2, _, c, l, b);
              case "o":
                return a(v, 8, _, c, l, b);
              case "x":
                return a(v, 16, _, c, l, b);
              case "X":
                return a(v, 16, _, c, l, b).toUpperCase();
              case "u":
                return a(v, 10, _, c, l, b);
              case "i":
              case "d":
                return (
                  (d = +v || 0),
  ...
  function (t, e, n) {
    ...
    e.getScrollbarWidth = function () {
      ...
      var o = e.offsetWidth;
      return document.body.removeChild(t), (r = n - o);
    };

  ...
  function (t, e) {
    ...
    !(function (t, e) {
      ...
      (function (t) {
        ...
        213: function (t, e, n) {
          var i = n(161)(Object.keys, Object);
          t.exports = i;
        },
        214: function (t, e, n) {
          var i = n(44)(n(19), "DataView");
          t.exports = i;
        },
        215: function (t, e, n) {
          var i = n(54),
    ...
    !(function (t, e) {
      ...
      (function (t) {
            ...
            et_pb_custom.page_id,
              (function (n) {
                var i =
                  ...
                  c = s.isBuilder || i ? ET_Builder.Frames.top : window,
                  _ = n(window),
                  d = n(i ? c : window),
                  p = s.isBuilder ? c.jQuery(c) : n(window),
                  u = n("body").hasClass("et-tb"),
                  ...
                  v = function () {
                    return s.isBuilder && n("html").is(".et-fb-preview--zoom");
                  },
                  m = function (t) {
                ...
                if (
                  ...
                  (window.et_pb_init_modules = function () {
                    (n.et_pb_simple_slider = function (t, e) {
                      var i,
                        ...
                        c = n(t),
                        l = c.closest_descendent(r.slide),
                        d = l.length,
                        p = r.fade_speed,
                        u = r.active_slide,
                        f = "",
                        h = "",
                        b =
                          (c.find(".et_pb_container").width(),
                          c.hasClass("et_pb_post_slider")),
                        v = !1;
                      if (
                        ((c.et_animation_running = !1),
                        n.data(t, "et_pb_simple_slider", c),
                        l.eq(0).addClass("et-pb-active-slide"),
                        c.attr("data-active-slide", l.data("slide-id")),
                        r.tabs_animation ||
                          c.hasClass("et_pb_bg_layout_dark") ||
                          c.hasClass("et_pb_bg_layout_light") ||
                          c.addClass(C(l.eq(0))),
                        r.use_arrows &&
                          d > 1 &&
                          ("" == r.manual_arrows
                          ...
                          c.on(
                            ...
                            function () {
                              return (
                                c.et_animation_running ||
                                  c.et_slider_move_to("next"),
                                !1
                              );
                            }
                          ),
                        ...
                        c.find("video").length > 0 &&
                          ...
                          "" == r.append_controls_to
                            ? c.append(f)
                            : n(r.append_controls_to).append(f),
                          (i = r.controls_below
                            ? c.parent().find(r.controls)
                            : c.find(r.controls)).on(
                            "click.et_pb_simple_slider",
                            function () {
                              return (
                                c.et_animation_running ||
                                  c.et_slider_move_to(n(this).index()),
                                !1
                              );
                            }
                          );
                      }
                      if (r.use_carousel && d > 1) {
                        for (m = 1; m <= d; m++) {
                          var g = m - 1,
                            w =
                              void 0 !== l.eq(g).data("image")
                                ? "url(".concat(l.eq(g).data("image"), ")")
                                : "none";
                          h +=
                        ...
                        (h =
                          ...
                          (a = c
                            ...
                            "click.et_pb_simple_slider",
                            function () {
                              if (c.et_animation_running) return !1;
                              var t = n(this);
                              return (
                                c.et_slider_move_to(t.data("slide-id")), !1
                              );
                            }
                          );
                      }
                      function y() {
                        v ||
                          (c.hasClass("et_pb_pause_slider")
                            ? setTimeout(function () {
                                y();
                              }, 2e3)
                            : r.slideshow &&
                              d > 1 &&
                              !c.hasClass("et_slider_hovered") &&
                      ...
                      function x() {
                        ...
                        isNaN(s) ||
                          (e.find("img").css("maxHeight", "".concat(s, "px")),
                          (l = parseInt(e.height()))),
                          !isNaN(l) &&
                      ...
                      r.slideshow &&
                        ...
                        c
                          .on("mouseenter.et_pb_simple_slider", function () {
                            c.hasClass("et_slider_auto_ignore_hover") ||
                              (c.addClass("et_slider_hovered"),
                              void 0 !== o && clearTimeout(o));
                          })
                          .on("mouseleave.et_pb_simple_slider", function () {
                            c.hasClass("et_slider_auto_ignore_hover") ||
                              (c.removeClass("et_slider_hovered"), y());
                          }),
                        y(),
                        (c.et_slider_destroy = function () {
                          void 0 !== o && clearTimeout(o),
                            (v = !0),
                            c.off(".et_pb_simple_slider"),
                            c
                              .find(".et_pb_slide")
                            ...
                            c
                              ...
                              .remove(),
                            c.removeData("et_pb_simple_slider");
                        }),
                        (c.et_fix_slider_content_images = x),
                        window.et_load_event_fired
                          ? "function" == typeof et_fix_slider_height &&
                            et_fix_slider_height(c)
                          : _.on("load", function () {
                              "function" == typeof et_fix_slider_height &&
                                et_fix_slider_height(c);
                            }),
                        _.on("resize.et_simple_slider", function () {
                          et_fix_slider_height(c);
                        }),
                        (c.et_slider_move_to = function (t) {
                          var e = (l = c.closest_descendent(r.slide)).eq(u);
                          if (
                            ((c.et_animation_running = !0),
                            c
                              .removeClass(
                            ...
                            if (u === t)
                              return (
                                ...
                                void (c.et_animation_running = !1)
                              );
                            u = t;
                          }
                          c.attr("data-active-slide", l.eq(u).data("slide-id")),
                            void 0 !== o && clearTimeout(o);
                          var _ = l.eq(u);
                          c.trigger("slide", { current: e, next: _ }),
                            void 0 !== e.find("video")[0] &&
                              void 0 !== e.find("video")[0].player &&
                              e.find("video")[0].player.pause(),
                            void 0 !== _.find("video")[0] &&
                              void 0 !== _.find("video")[0].player &&
                              _.find("video")[0].player.play();
                          var f,
                            h,
                            v,
                          ...
                          c.trigger("simple_slider_before_move_to", {
                            ...
                            r.use_carousel &&
                              ...
                              a
                                ...
                                .addClass(r.control_active_class),
                            r.tabs_animation
                              ? (_.css({ display: "none", opacity: 0 }),
                                e
                                  .addClass("et_slide_transition")
                                  .css({ display: "block", opacity: 1 })
                                  .animate({ opacity: 0 }, p, function () {
                                    n(this)
                                      .css("display", "none")
                                ...
                                e
                                  ...
                                  .animate({ opacity: 0 }, p, function () {
                                    ...
                                    s.isBuilder
                                      ...
                                      c.removeClass(o).addClass(r),
                                      (c.et_animation_running = !1),
                                      c.trigger("simple_slider_after_move_to", {
                                        next_slide: _,
                                      });
                                  })),
                            _.find(".et_parallax_bg").length &&
                              window.et_pb_parallax_init(
                                _.find(".et_parallax_bg")
                              ),
                            y();
                        });
                    }),
                          ...
                          if (-1 !== a.indexOf(e, 0)) {
                            for (
                              ...
                              r[c].split(g)[0] === i
                                ...
                                : o.push(r[c]);
                            s || o.push(t);
                          } else a.split(g)[0] !== i && o.push(a), o.push(t);
                          a = o.join(e);
                        } else a = t;
                    ...
                    (n.et_pb_simple_carousel = function (t, e) {
                      ...
                      n(function () {
                        ...
                        var C = n(".et_pb_slider"),
                          k = n(".et_pb_tabs"),
                          j = n(".et_pb_section_video_bg"),
                          T = n(".et_pb_newsletter_button"),
                          O = n(".et_pb_newsletter_field .input"),
                          S = n(".et_pb_filterable_portfolio"),
                          z = n(".et_pb_fullwidth_portfolio"),
                          P = n(".et_pb_gallery"),
                          A = n(".et_pb_countdown_timer"),
                          E = n(".et_post_gallery"),
                          I = n(".et_pb_lightbox_image"),
                          B = n(".et_pb_map_container"),
                          H = n(".et_pb_circle_counter"),
                          M = n(".et_pb_number_counter"),
                          L = n(".et_parallax_bg"),
                          F =
                            (n(".et_pb_shop"),
                            n(
                          ...
                          q = null !== navigator.userAgent.match(/MSIE 9.0/),
                          $ = n(".et_pb_row"),
                          N =
                            window.et_pb_custom &&
                          ...
                          Z =
                            (U.find(".et_post_meta_wrapper").first().find("h1"),
                            U.find(".entry-content").first(),
                            n("body.single-post"),
                            n(".et_header_style_split"),
                            n("#et-top-navigation"),
                            n("#logo"),
                            n(".et_pb_image_sticky")),
                          Y = n(".et_pb_counter_amount"),
                          G = n(".et_pb_carousel"),
                          J =
                            window.et_pb_custom &&
                        ...
                        if (
                          ...
                          void 0 !== Ht("et_pb_ab_shop_log") &&
                          "" !== Ht("et_pb_ab_shop_log")
                        ) {
                          var ot = Ht("et_pb_ab_shop_log").split("_");
                          Pt("con_goal", ot[0], ot[1], ot[2]),
                        ...
                        if (
                          ...
                          q && n("body").addClass("et_ie9"),
                          (j.length || s.isBuilder) &&
                          ...
                          var st = n.magnificPopup.instance;
                          n("body").on(
                            "swiperight",
                            ".mfp-container",
                            function () {
                        ...
                        if (
                          ...
                          (C.length || s.isBuilder) &&
                            C.each(function () {
                              var t = n(this);
                              et_pb_slider_init(t);
                            }),
                          ((G = n(".et_pb_carousel")).length || s.isBuilder) &&
                            G.each(function () {
                              n(this).et_pb_simple_carousel({
                                slide_duration: 1e3,
                              });
                            }),
                          (nt.length || s.isBuilder) &&
                            n(nt).each(function () {
                        ...
                        if (
                          ((P.length || s.isBuilder) &&
                            ...
                            et_pb_gallery_pagination_nav(P),
                            s.isBuilder &&
                          ...
                          (k.length || s.isBuilder) &&
                            window.et_pb_tabs_init(k),
                          B.length || s.isBuilder)
                        ) {
                          var pt = function () {
                            B.each(function () {
                                  ...
                                  t.easyPieChart({
                                    ...
                                    onStop: function (t, e) {
                                      n(this.el)
                                        .find(".percent-value")
                                        .text(
                                          i(n(this.el).data("number-value"), a)
                                        );
                                    },
                                  });
                                });
                            }),
                            window.et_pb_reinit_number_counters(M)),
                            ...
                            if (
                              ...
                              if (!a.hasClass("et_is_animating")) {
                                if (i) {
                                  ...
                                  o += c.jQuery(s).offset().top;
                                }
                                var l,
                                  _ = 0.3 * (r + p.height() - o);
                                (l = "translate(0, ".concat(_, "px)")),
                          ...
                          (window.et_apply_builder_css_parallax = function () {
                            if (s.isBuilder || i) {
                              ...
                              if (
                                ...
                                var a = u ? c.jQuery("#et-fb-app") : p,
                                  o = a.scrollTop(),
                                  l = f
                                    ? c.jQuery("#et_pb_layout .inside").offset()
                                        .top
                                    : 0,
                                  _ = v() ? 2 : 1,
                                  d = t.offset(),
                                ...
                                i &&
                                  ((a = c.jQuery(
                                    (0, r.getContentAreaSelector)(c, !0)
                                  )),
                                  (l = c
                                    .jQuery(
                        ...
                        var ut =
                          ...
                          ft = n(".et_pb_contact_form_container"),
                          ht =
                            !s.isBuilder &&
                          ...
                          e &&
                            ...
                            e.each(function () {
                              ...
                              i.css("height", ""),
                                ...
                                "object" ===
                                  l(n(this).data("et_pb_simple_slider")) &&
                                  n(this)
                                    .data("et_pb_simple_slider")
                        ...
                        function xt(t, e, n) {
                          ...
                          if (i.length < n) {
                            ...
                            a &&
                              a.length > 0 &&
                              (i.push(a[0]), t.data("et_waypoint", i));
                        ...
                        function kt(t) {
                          ...
                          if (!e.hasClass("et_had_animation")) {
                            ...
                            e.is(".et_pb_section") &&
                              ...
                              (function (t) {
                                for (
                                  var e = [], i = t.get(0).attributes, a = 0;
                                  a < i.length;
                                  a++
                                )
                                  "data-animation-" ===
                                    i[a].name.substring(0, 15) &&
                                    e.push(i[a].name);
                        ...
                        function zt(t, e, n) {
                          if (!s.isBuilder) {
                            ...
                            t.hasClass("et_pb_ab_goal") && !K[i][a]
                              ? Pt(a, i)
                              : void 0 !== n && n();
                          }
                        }
                        ...
                        (window.et_fix_slider_height = s.isBuilder
                          ? function (t) {
                              var e = t || C;
                              if (e && e.length) {
                                var n = e.data("address");
                                wt[n] ||
                                  (wt[n] = window.et_pb_debounce(gt, 100)),
                                  wt[n](t);
                              }
                            }
                          : gt),
                          ...
                          (window.et_pb_submit_newsletter = function (t, e) {
                            if (t.closest(".et_pb_login_form").length)
                              zt(t.closest(".et_pb_newsletter"), "con_goal");
                            else {
                              if (
                              ...
                              if (
                                ...
                                var T = n.Deferred();
                                et && a.hasClass("et_pb_recaptcha_enabled")
                                  ? et
                                      .interaction(
                        ...
                        function Wt() {
                          ...
                          gt(), et_calculate_fullscreen_section_size();
                        }
                        function qt() {
                        ...
                        (window.et_calc_fullscreen_section = function (t, e) {
                          var i = "object" === l(t) && "resize" === t.type,
                            a = n(c),
                            o = e || n(this),
                            ...
                            s =
                              ...
                              t.target.window_width > Ft[r]
                                ...
                                : 0;
                          (Ft[r] = a.width()),
                            void 0 !== Dt[r] && clearTimeout(Dt[r]),
                            (Dt[r] = setTimeout(function () {
                              var t = n("body"),
                                ...
                                d = _.children(".header-content-container"),
                                p = _.children(".header-image-container"),
                                u = c.innerHeight || a.height(),
                                f = c.jQuery("#wpadminbar"),
                                h = f.length,
                                b = h ? f.height() : 0,
                                v = n("#top-header"),
                                m = v.length,
                                ...
                                O = void 0 !== l.top && l.top <= T,
                                S = c.jQuery(".edit-post-header"),
                                z = c.jQuery(".edit-post-layout__footer");
                              ...
                              if (
                                ...
                                setTimeout(function () {
                                  o.css("min-height", "".concat(u, "px")),
                                    _.css("min-height", "".concat(u, "px"));
                                }, 100),
                                _.hasClass("center") &&
                                  d.hasClass("bottom") &&
                                  p.hasClass("bottom") &&
                                  _.addClass("bottom-bottom"),
                                _.hasClass("center") &&
                                  d.hasClass("center") &&
                                  p.hasClass("center") &&
                                  _.addClass("center-center"),
                                _.hasClass("center") &&
                                  d.hasClass("center") &&
                                  p.hasClass("bottom"))
                              ) {
                                _.addClass("center-bottom");
                                var E = u - p.outerHeight(!0);
                                E > 0 &&
                                  d
                              ...
                              _.hasClass("center") &&
                                d.hasClass("bottom") &&
                                p.hasClass("center") &&
                                _.addClass("bottom-center"),
                                (_.hasClass("left") || _.hasClass("right")) &&
                                  !d.length &&
                                  p.length &&
                                  _.css("justify-content", "flex-end"),
                                _.hasClass("center") &&
                                  d.hasClass("bottom") &&
                                  !p.length &&
                                  d
                                ...
                                d.hasClass("bottom") &&
                                  ...
                                  (p
                                    .find(".header-image")
                                    .css("margin-bottom", "".concat(80, "px")),
                                  p.css("align-self", "flex-end"));
                              var I = 0;
                              d.length && (I += d.outerHeight()),
                                p.length && (I += p.outerHeight()),
                                I > u &&
                                  (o.css("min-height", "".concat(I, "px")),
                                  _.css("min-height", "".concat(I, "px"))),
                                p.hasClass("bottom") &&
                                  (I < u &&
                                    (o.css(
                                      "min-height",
                          ...
                          s.isBuilder
                            ? n(window).one("et_fb_init_app_after", Wt)
                            : Wt(),
                          (window.et_pb_fullwidth_header_scroll = function (t) {
                            ...
                            var e = _.width(),
                              ...
                              d = n("#wpadminbar"),
                              p = n("#main-header"),
                              u = d.length && !a ? d.height() : 0,
                              f =
                                Q.length && window.et_is_fixed_nav && s
                                  ? Q.height()
                                  : 0,
                              b =
                                void 0 === p.attr("data-height-onload")
                                  ? 0
                                  : p.attr("data-height-onload"),
                              v =
                                p.height() === Lt() ||
                                !s ||
                                !window.et_is_fixed_nav ||
                                ...
                                r
                                  ...
                                  : Lt() - parseFloat(b),
                              m =
                                l.top + c.outerHeight(!0) + v - (u + f + Lt());
                          ...
                          (window.et_pb_search_init = function (t) {
                            ...
                            var n = "desktop" !== e ? "-".concat(e) : "",
                              ...
                              o = t.hasClass("et_pb_text_align_right".concat(n))
                                ? "paddingLeft"
                                : "paddingRight",
                              r =
                                "paddingLeft" === o
                  ...
                  var g = et_pb_custom.ab_tests.length;
                  n.each(et_pb_custom.ab_tests, function (t, e) {
                    n.ajax({
                      type: "POST",
                      url: et_pb_custom.ajaxurl,
                      ...
                      n(".et_pb_woo_custom_button_icon").length > 0 &&
                        n(".et_pb_woo_custom_button_icon").each(function () {
                          var t = n(this),
                            ...
                            i = t.find(".".concat(e)),
                            a = t.attr("data-button-icon"),
                            o = t.attr("data-button-icon-tablet"),
                            r = t.attr("data-button-icon-phone");
                          i.addClass("et_pb_promo_button et_pb_button"),
                            (a || o || r) &&
                              (i.addClass("et_pb_custom_button_icon"),
                              i.attr("data-icon", a),
                              i.attr("data-icon-tablet", o),
                              i.attr("data-icon-phone", r));
                        }),
                ...
                var x = {
                  ...
                  normalStateHandler: function (t) {
                    t &&
                      !x.isEmptyObject(t.normalState) &&
                      x.callbackHandlerDefault(
                        t.normalState,
                        t.$target,
                        t.$source,
                        t.slug
                  ...
                  setHoverState: function (t, e) {
                    x.resetHoverState();
                    var i = [];
                    t.data("etMultiView") && i.push(x.getData(t)),
                      t.find("[data-et-multi-view]").each(function () {
                        var t = n(this);
                        x.isBuilderElement(t) || i.push(x.getData(t));
                      });
                    for (var a = 0; a < i.length; a++) {
                      var o = i[a];
                      !o ||
                        x.isEmptyObject(o.normalState) ||
                        x.isEmptyObject(o.hoverState) ||
                        x.callbackHandlerDefault(
                          o.hoverState,
                          o.$target,
                          o.$source,
                  ...
                  getData: function (t) {
                    ...
                    if (!i) return !1;
                    if (
                      ("string" == typeof i && (i = x.tryParseJSON(i)),
                      !i || !i.schema || !i.slug)
                    )
                      return !1;
                  ...
                  callbackHandlerDefault: function (t, e, n, i) {
                    if (i) {
                      var a = x.getCallbackHandlerCustom(i);
                      if (a && "function" == typeof a) return a(t, e, n, i);
                    }
                    var o = {};
                    return (
                      t.hasOwnProperty("content") &&
                        (o.content = x.updateContent(t.content, e, n)),
                      t.hasOwnProperty("attrs") &&
                        (o.attrs = x.updateAttrs(t.attrs, e, n)),
                      t.hasOwnProperty("styles") &&
                        (o.styles = x.updateStyles(t.styles, e, n)),
                      t.hasOwnProperty("classes") &&
                        (o.classes = x.updateClasses(t.classes, e, n)),
                      t.hasOwnProperty("visibility") &&
                        (o.visibility = x.updateVisibility(t.visibility, e, n)),
                      !x.isEmptyObject(o) && o
                    );
                  },
                  callbackHandlerCounter: function (t, e, n) {
                    var i = x.callbackHandlerDefault(t, e, n);
                    i &&
                      i.attrs &&
                  ...
                  callbackHandlerCircleCounter: function (t, e, n) {
                    ...
                    if (
                      ...
                      x.updateAttrs({ "data-number-value": o }, a, n) &&
                        a.data("easyPieChart") &&
                  ...
                  callbackHandlerVideoSlider: function (t, e, n) {
                    ...
                    if (e.hasClass("et_pb_slider") && i && i.classes) {
                      ...
                      if (a) {
                        ...
                        "object" === l(o) && o.et_slider_destroy(),
                          et_pb_slider_init(e),
                  ...
                  callbackHandlerSliderItem: function (t, e, i) {
                    if (!e.hasClass("et_pb_slide_video") && !e.is("img"))
                      return x.callbackHandlerDefault(t, e, i);
                      ...
                      if (
                        (a.hasClass("wp-video") && o.hasClass("wp-video")
                          ? (function () {
                            ...
                            })() && (r = x.callbackHandlerDefault(t, e, i))
                          : ((a.is("iframe") &&
                              o.is("iframe") &&
                    ...
                    return o && r
                      ? (o.is("video") && r.is("video")
                          ? (function () {
                            ...
                            })() && (a = x.callbackHandlerDefault(t, e, i))
                          : ((o.is("iframe") &&
                              r.is("iframe") &&
                  ...
                  getScreenMode: function () {
                    if (s.isBuilder && x.screenMode) return x.screenMode;
        ...
        347: function (t, e, n) {
          ...
          e.getContentAreaSelectorList = function () {
            return {
          ...
          var _ = function (t) {
            ...
            return (
              n +
              ((0, a.default)(t.document.querySelector(l("5.5", !0)))
                ? (0, a.default)(t.document.querySelector(l("5.4", !0)))
                  ? (0, a.default)(
                      t.document.querySelector(l("gutenberg-7.1", !0))
                    )
                    ? l("5.2")
                    : l("gutenberg-7.1")
                  : l("5.4")
  ...
  function (t, e, n) {
    ...
    var c = function (t) {
      ...
      _ =
        ...
        l("extraTheme"),
        c("lbp"),
        r()(s.a.document).find(".edit-post-layout__content").length,
        a()(
          ["vb", "bfb", "tb", "lbb"],
          window.et_builder_utils_params.builderType
        ));
    !(function (t) {
      ...
      var e = _ ? ET_Builder.Frames.top : window,
        n = {};
      function i() {
      ...
      if (
        (document.addEventListener("DOMContentLoaded", function () {
          ...
          if (
            ...
            var I = t("ul.et_disable_top_tier > li > ul").prev("a");
            I.attr("href", "#"),
              I.on("click", function (t) {
                t.preventDefault();
              });
          ...
          if (
            ...
            var H = t(".et_slide_in_menu_container").find(
          ...
          function M(n) {
            setTimeout(function () {
              var n = 0,
                i = t("body"),
                a = _ ? e.jQuery("#wpadminbar") : t("#wpadminbar"),
                o = e.jQuery("html"),
                r = t("#top-header"),
          ...
          function W() {
            ...
            if (u.length > 0 && "yes" !== u.attr("data-position-set")) {
              var h = l;
              0 === h &&
                v.attr("data-height-onload") &&
                (h = v.attr("data-height-onload")),
                u.css("marginTop", parseFloat(h) + "px"),
                u.animate({ opacity: "1" }),
                u.attr("data-position-set", "yes");
            }
            var w = t(document).height(),
              C = t(window).height() + y + 200 > w,
              k = parseInt(t(window).width()) > 980 && f;
            if (
              !window.et_is_transparent_nav ||
              window.et_is_vertical_nav ||
              (k && !C)
              ...
              var j = i().length,
                ...
                P = z.length && S.length,
                A = z.length && 0 === S.length,
                E = T && t(".et-l--body").length,
                I = i().is(".et_pb_fullwidth_section"),
                B = s <= 980 && r.length,
                H = t("body").hasClass("single-project");
              if (E || !T || (A && I) || H)
                if (I) {
                  var L = i().children(".et_pb_module:visible").first();
                  if ((A && I && s > 980 && (e -= 58), L.is(".et_pb_slider"))) {
                    var W = L.find(".et_pb_slide_image"),
                      q = L.find(".et_pb_slide"),
                      $ = L.find(".et_pb_slide .et_pb_container"),
                      N = 0 - parseInt(W.height()) / 2,
                      V = L.find(".et-pb-slider-arrows a"),
                      R = V.height();
                    F(q, "paddingTop"),
                      q.css({ paddingTop: e + "px" }),
                      $.css({ "min-height": "" }),
                      F(W, "marginTop"),
                      W.css({ marginTop: N + "px" }),
                      F(V, "marginTop"),
                    ...
                    F(L, "paddingTop"), L.css({ paddingTop: e + "px" });
                    ...
                    L.is(".et_pb_menu") ||
                    L.is(".et_pb_fullwidth_menu")
                  )
                    F(L, "marginTop"), L.css({ marginTop: e + "px" });
                  ...
                  X || K || tt
                    ? (s > 980 && X
                      ...
                      (J = parseInt(i().css("paddingTop"))),
                      i().css({ paddingTop: e + J + "px" }))
          ...
          (window.et_change_primary_nav_position = M),
          ...
          t(window).on("resize", function () {
            var n,
              ...
              b = _ ? e.jQuery("#wpadminbar") : t("#wpadminbar"),
              g = t("body").hasClass("rtl");
            (a && u && (q(), j.data("previous-width", p)),
            f && L(),
            ((b.length && a && r >= 740 && r <= 782) || _) &&
              (et_calculate_header_values(), M(0)),
            Z(),
            h.length &&
              !t("body").hasClass("et_pb_slide_menu_active") &&
              (g
                  ...
                  if (
                    ...
                    return (
                      t(this).parents().hasClass("widget_recent_reviews") &&
                        t(".reviews_tab")
                          .trigger("click")
                          .animate({ scrollTop: d.offset().top }, 700),
                      n.closest(".et_pb_fullscreen_menu_opened").length > 0 &&
                        p(),
                      setTimeout(function () {
                        et_pb_smooth_scroll(d, !1, 800);
                      }, 0),
                      !t("#main-header").hasClass("et-fixed-header") &&
                        t("body").hasClass("et_fixed_nav") &&
                        t(window).width() > 980 &&
                        setTimeout(function () {
                          et_pb_smooth_scroll(d, !1, 40, "linear");
                        }, 780),
                      !1
                    );
                }
          ...
          var N,
            ...
            Q = function () {
              var e,
                n = t(".et-l--post"),
                i = t(".et-l--body .et_pb_section").not(
              ...
              if (t(".et_pb_side_nav_page").length) {
                ...
                (window.et_side_nav_links_initialized = !1),
                  ...
                  n > 1 &&
                    ...
                    t("ul.et_pb_side_nav").css("marginTop", "-" + i + "px"),
        ...
        var f = t(".et_header_style_fullscreen .et_slide_in_menu_container");
        if (f.length) {
          var h = f.find(".et_slide_menu_top").innerHeight();
          f.css({ "padding-top": h + 20 + "px" });
        }
      }

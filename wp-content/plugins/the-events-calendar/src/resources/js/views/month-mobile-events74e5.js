...
(function ($, obj) {
  ...
  obj.selectors = {
    ...
    mobileEventsDefaultNotices:
      ".tribe-events-header__messages--mobile:not(.tribe-events-header__messages--day)", // eslint-disable-line max-len
  };
  ...
  obj.handleMobileDayClick = function ($container, showDefaultNotices) {
    ...
    var daySelected =
      $container.find(obj.selectors.mobileEventsMobileDayShowClass).length > 0;
